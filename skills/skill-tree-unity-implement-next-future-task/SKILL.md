---
name: skill-tree-unity-implement-next-future-task
description: >
  Implement exactly one task from the Prioritized Next Changes section of
  a Unity repository FUTURE.md. Use for "Implement next", "Implement next feature",
...
# Skill-Tree-Unity: Implement Next Task

Use this skill to implement exactly one eligible Unity task from `Prioritized Next Changes`.
